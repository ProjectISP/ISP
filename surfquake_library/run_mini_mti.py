...
if __name__ == "__main__":
    ...
    path_to_configfiles = '/Users/robertocabiecesdiaz/Documents/test_surfquake/inputs/configs/mti_config_mini_test.ini'
    output_directory = '/Users/robertocabiecesdiaz/Documents/test_surfquake/my_test/mti'
    # #
    # # Load the Project
    ...
    #file_summary = os.path.join(output_directory, "summary_mti.txt")
