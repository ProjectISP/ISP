...
def read_nlloc_hyp_ISP(filename, coordinate_converter=None, picks=None, **kwargs):
    """
...
def _read_single_hypocenter(lines, coordinate_converter, original_picks):
    ...
    for line in phases_lines:
        ...
        setattr(arrival, "instrument", line[1])
        setattr(arrival, "component", line[2])
        ...
        arrival.azimuth_ml = float(line[22])
