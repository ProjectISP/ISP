...
from isp.Gui.Frames import BaseFrame, UiNewGuiFrame, Pagination, MessageDialog, EventInfoBox, \
    MatplotlibCanvas
...
class NewGuiFrame(BaseFrame, UiNewGuiFrame):

    def __init__(self):
        super(NewGuiFrame, self).__init__()
        self.setupUi(self)
