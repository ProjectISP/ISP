...
Cabieces, R.,García-Yeguas, A., Villaseñor, A., Buforn, E., Pazos, A.,Krüger, F., Olivar, A.,Barco, J. (2019) Slowness vector estimation over large-aperture sparse arrays with the Continuous Wavelet Transform: Application to Ocean Bottom Seismometers. Geophys. J. Int. (submitted, september 2018 editor accepted).
"""
