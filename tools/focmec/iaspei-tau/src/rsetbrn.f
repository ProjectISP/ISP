...
c   PKiKP.
cj      print *,'Layout:  do PKiKP'
cj      call mkrbr(2,       -1,2,1,1,dir)
c   pP.
cj      print *,'Layout:  do pP'
cj      call mkdbr(1,lbb(1),+1,3,1,1,dir)
c   sP.
cj      print *,'Layout:  do sP'
cj      call mkdbr(1,lbb(1),+2,3,1,1,dir)
c   pPKiKP.
cj      print *,'Layout:  do pPKiKP'
cj      call mkrbr(2,       +1,2,1,1,dir)
c   sPKiKP.
cj      print *,'Layout:  do sPKiKP'
cj      call mkrbr(2,       +2,2,1,1,dir)
c   PcP.
cj      print *,'Layout:  do PcP'
cj      call mkrbr(3,       -1,1,1,1,dir)
c   ScP.
cj      print *,'Layout:  do ScP'
cj      call mkrbr(3,       -2,1,2,1,dir)
c   SKP.
cj      print *,'Layout:  do SKP'
cj      call mkdbr(1,3,     -2,3,2,1,dir)
c   SKiKP.
cj      print *,'Layout:  do SKiKP'
cj      call mkrbr(2,       -2,2,2,1,dir)
c   PKKP.
cj      print *,'Layout:  do PKKP'
cj      call mkdbr(1,3,     -1,3,1,1,cref)
c   SKKP.
cj      print *,'Layout:  do SKKP'
cj      call mkdbr(1,3,     -2,3,2,1,cref)
c   PP and P'P'.
cj      print *,'Layout:  do PP, P''P'''
cj      call mkdbr(1,lbb(1),-1,3,1,1,sref)
c   S (up-going branch).
      print *,'Layout:  do Sup'
      call mkubr(ku(2),   +2)
c   S, Sdiff, and SKS.
...
c   pS
cj      print *,'Layout:  do pS'
cj      call mkdbr(1,lbb(1),+1,3,2,2,dir)
c   sS
cj      print *,'Layout:  do sS'
cj      call mkdbr(1,lbb(2),+2,3,2,2,dir)
c   ScS
cj      print *,'Layout:  do ScS'
cj      call mkrbr(4,       -2,1,2,2,dir)
c   PcS
cj      print *,'Layout:  do PcS'
cj      call mkrbr(3,       -1,1,1,2,dir)
c   PKS
cj      print *,'Layout:  do PKS'
cj      call mkdbr(1,3,     -1,3,1,2,dir)
c   PKKS
cj      print *,'Layout:  do PKKS'
cj      call mkdbr(1,3,     -1,3,1,2,cref)
c   SKKS
cj      print *,'Layout:  do SKKS'
cj      call mkdbr(1,3,     -2,3,2,2,cref)
c   SS and S'S'.
cj      print *,'Layout:  do SS and S''S'''
cj      call mkdbr(1,lbb(2),-2,3,2,2,sref)
c   SP
cj      print *,'Layout:  do SP'
cj      call mkcbr(4,lbb(1),-2,1,2,1,sref)
c   PS
cj      print *,'Layout:  do PS'
cj      call mkcbr(4,lbb(1),-1,1,1,2,sref)
      return
      end
c
